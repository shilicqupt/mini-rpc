...
public class IOUtils {
     ...
     */
    public static void copyBytes(InputStream in, OutputStream out, org.apache.hadoop.conf.Configuration conf)
            throws IOException {
     ...
     * OutputStream at the end. The streams are closed in the finally clause.
     */
    public static void copyBytes(InputStream in, OutputStream out, org.apache.hadoop.conf.Configuration conf, boolean close)
            throws IOException {
