...
public final class WritableUtils  {
     ...
     */
    public static <T extends Writable> T clone(T orig, org.apache.hadoop.conf.Configuration conf) {
        try {
            @SuppressWarnings("unchecked") // Unchecked cast from Class to Class<T>
                    T newInst = org.apache.hadoop.util.ReflectionUtils.newInstance((Class<T>) orig.getClass(), conf);
